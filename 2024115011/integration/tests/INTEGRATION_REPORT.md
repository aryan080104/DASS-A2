...
Additional verification graphs:
- [call_graph_v2.png](call_graph_v2.png) (cross-module function-focused)
- [call_graph_v3.png](call_graph_v3.png) (module-to-module architecture)
- [call_graph_detailed.png](call_graph_detailed.png) (fully annotated function-level graph)
- Generator script: [generate_call_graph_detailed.py](generate_call_graph_detailed.py)
